...
class Login extends React.Component {
    ...
    scriptjs.get(
      ...
      () => {
        const params = {
          ...
          redirectURI: "https://syncfast.macrotechsolutions.us/appleAuth",
          scope: "name email",
        };
  ...
  async onSuccess(googleUser) {
    ...
    let response = await fetch(
      "https://syncfast.macrotechsolutions.us:9146/http://localhost/googleSignIn",
      {
        method: "POST",
        headers: {
  ...
  async signInEmail(e) {
    ...
    let response = await fetch(
      "https://syncfast.macrotechsolutions.us:9146/http://localhost/signIn",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
      ...
      <div>
        ...
        <div className="page">
          <div className="box">
            ...
            />
            <div style={{width: "210px",  height: "40px", marginTop: "10px"}} id="appleid-signin" class="signin-button" data-color="black" data-border="true" data-type="sign in"><button onClick={() => window.AppleID.auth.signIn()}/></div>
